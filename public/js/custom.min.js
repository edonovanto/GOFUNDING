$(function() {
    ...
    var i = function() {
        (window.innerWidth > 0 ? window.innerWidth : this.screen.width) < 768 ? ($("body").addClass("mini-sidebar"), 
        $(".navbar-brand span").hide(), $(".navbar-brand b").show(), $('.mnu a').show(), $('.ttl span').hide(), $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"), 
        $(".sidebartoggler i").addClass("ti-menu")) : ($("body").removeClass("mini-sidebar"), 
        $(".navbar-brand b").hide(), $('.mnu a').hide(), $('.ttl span').show(), $(".navbar-brand span").show());
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
        ...
        $("body").removeClass("mini-sidebar"), $(".navbar-brand b").hide(), $('.mnu a').hide(), $('.ttl span').show(), $(".navbar-brand span").show()) : ($("body").trigger("resize"), 
        $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"), 
        $("body").addClass("mini-sidebar"), $(".navbar-brand b").show(), $('.mnu a').show(), $('.ttl span').hide(), $(".navbar-brand span").hide());
    }), $(".fix-header .topbar").stick_in_parent({}), $(".nav-toggler").click(function() {
        $("body").toggleClass("show-sidebar"), $(".nav-toggler i").toggleClass("fa fa-navicon"), 
