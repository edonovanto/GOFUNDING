...
<body>
	...
	<nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html" ><img src="images/Asset1.png" style="width: 150px" /></a>
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
				<div class="col-md-6 ftco-animate">
					<h2 class="subheading">Bersama kami,</h2>
					<h1>Mengurus Proposal Dana Dengan
						<span
						class="txt-rotate"
						data-period="2000"
						data-rotate='[ "Mudah.", "Nyaman.", "Cepat.", "Aman." ]'></span>
					</h1>
			...
			<div class="row">
				<div class="col-lg-3 py-5">
					<div class="heading-section ftco-animate">
						<span class="subheading">Kenapa</span>
						<h2 class="mb-4">harus Kami?</h2>
						<p>Jutaan orang tidak menyadari bahwa proses meminta dana ke akademik sangatlah membingungkan, padahal ada Gofunding untuk mengatasi masalah tersebut. </p>
		...
		padding-bottom: 20px">
			<div class="row d-flex">
				<div class="col-md-6 d-flex">
					<div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-end" style="background-image:url(images/Asset1.png); margin:50px">
				...
				<div class="col-md-6 pl-md-5">
					<div class="row justify-content-start pt-3 pb-3">
						<div class="col-md-12 heading-section ftco-animate">
							...
							<h2 class="mb-4" style="color: #15bded">Tentang Kami</h2>
							<p style="color: #fff">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
							<p><a href="tentang.html" class="btn btn-primary mr-md-4 py-2 px-4" style="color: #15bdeb !important">pelajari <span class="ion-ios-arrow-forward"></span></a></p>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="logo"><a href="#">PREDICTPLUS <span>Future Appraisal System</span></a></h2>
              <p>PredictPlus adalah website yang menyajikan data-data rumah yang dapat digunakan sebagai pembanding oleh bank</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Bulaksumur, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">(0274) 588688</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@ugm.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Partnership</h2>
                <ul class="list-inline list-unstyled">
                    <li class="list-inline-item"><img src="/images/yogya.png"  class="partner"></li>
                    <li class="list-inline-item"><img src="/images/bkad.png"  class="partner"></li>
                </ul>
            </div>
          </div>
        </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <strong>PREDICT</strong>PLUS</a>
